...
new-PSDrive -Name "DS001" -PSProvider "MDTProvider" -Root "C:\DeploymentShare" -Description "MDT Deployment Share" -NetworkPath "\\Server-Jie\DeploymentShare" -Verbose | add-MDTPersistentDrive -Verbose
...
import-mdttasksequence -path "DS001:\Task Sequences" -Name "OS with app" -Template "Client.xml" -Comments "Deploying Windows 11" -ID "1" -Version "1.0" -OperatingSystemPath "DS001:\Operating Systems\Windows 11 Pro in Windows 11 install.wim" -FullName "Windows User" -OrgName "jie.com" -HomePage "about:blank" -Verbose
$CSFile = @"
[Settings]
Priority=Default
...
[Default]
DeployRoot=\\Server-Jie\DeploymentShare
UserID=Administrator
UserPassword=Aeu0000298!@
UserDomain=jie.com
SkipBDDWelcome=YES
TaskSequenceID=1
"@ 
